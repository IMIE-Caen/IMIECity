...
public class Ressource {
    ...
    public final static int BLE=5;
    public final static int OUVRIER=6; // TOUJOURS EN DERNIER
    public final static String TAB[]=  {"Arbre", "Planche", "Fer", "Charbon","Acier", "Blé", "Ouvrier"};
